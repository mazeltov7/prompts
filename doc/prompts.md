...
・プロンプトエンジニア　[ついに発見！？ChatGPT を賢く使いこなすプロンプト（質問）の作り方４ステップ](https://miryokuhakkenn.com/chatgpt-prompt/?fbclid=IwAR3YlMz_mC2bXga3rnat50p_r4To2O_HMlnS2vJFPwRDxeuVXFq75CYQlwg)
やはりこれでもなりきり系はいまいちしっくりこない。
...
prompted by hayashi-san

```
瞬間英作文の問題を作ってください。
nと入力したら私が英訳の練習をするための新しい文章を日本語で出力してください。
aと入力したらその問題の英訳の例を出力してください。
その例について追加で質問したときには回答をお願いします。
